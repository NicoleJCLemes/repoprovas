...
import { findById, insert, findByEmail } from "../repositories/userRepository.js";
...
export function signUpService(body) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, findByUserEmail(body.email)];
                case 1:
                    user = _a.sent();
                    if (user) {
                        throw {
...
function findByUserEmail(email) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, findByEmail(email)];
                case 1:
                    user = _a.sent();
...
export function signInService(body) {
    return __awaiter(this, void 0, void 0, function () {
        var user, passwordMatches, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, findByUserEmail(body.email)];
                case 1:
