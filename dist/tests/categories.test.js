...
describe("GET /categories", function () {
    it("get categories", function () { return __awaiter(void 0, void 0, void 0, function () {
        var body, response, token, response2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    response = _a.sent();
                    token = response.text;
                    return [4 /*yield*/, supertest(app).get("/categories").set("Authorization", "Bearer ".concat(token))];
                case 3:
                    response2 = _a.sent();
